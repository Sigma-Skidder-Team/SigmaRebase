    ...
    public void onRender3D(Render3DEvent event) {
        if (this.isEnabled()) {
            if (this.rayTraceResult != null) {
                ...
                double x = pos.getX() - mc.gameRenderer.getActiveRenderInfo().getBlockPos().getX();
                double y = pos.getY() - mc.gameRenderer.getActiveRenderInfo().getBlockPos().getY();
                double z = pos.getZ() - mc.gameRenderer.getActiveRenderInfo().getBlockPos().getZ();
