...
public class AutoCrystal extends Module {
    ...
    public AutoCrystal() {
        ...
        this.registerSetting(
                new NumberSetting<Float>("CPS", "Click per seconds", 9.0F, Float.class, 1.0F, 20.0F, 1.0F));
    ...
    public static float method16380(double var0, double var2, double var4, Entity var6) {
        ...
        if (var6 instanceof LivingEntity) {
            var18 = method16382(
                    (LivingEntity) var6, method16381(var17),
                    new Explosion(mc.world, null, null, null, var0, var2, var4, 6.0F, false, Class2141.field14015));
        }
        ...
        if (!event.isPre()) {
            ...
            if ((float) this.field23636 >= 20.0F / this.getNumberValueBySettingName("CPS")) {
                EnderCrystalEntity var5 = mc.world
                        ...
                        .min(Comparator.comparing(var1x -> method16380(var1x.getPosX(), var1x.getPosY(),
                ...
                BlockPos var6 = this.field23637
                        ...
                        .max(
                                Comparator.comparing(
                                        var1x -> method16380(var1x.getX(), var1x.getY(), var1x.getZ(),
                                                this.field23633)))
                        .orElse(null);
                if (var6 != null) {
    ...
    private List<BlockPos> method16377() {
        ...
        var3.addAll(this.method16379(method16376(), 6.0F, 6, false, true, 0).stream().filter(this::method16378)
    ...
    public List<BlockPos> method16379(BlockPos var1, float var2, int var3, boolean var4, boolean var5, int var6) {
        ...
        for (int var13 = var10 - (int) var2; (float) var13 <= (float) var10 + var2; var13++) {
            for (int var14 = var12 - (int) var2; (float) var14 <= (float) var12 + var2; var14++) {
                for (int var15 = !var5 ? var11 : var11 - (int) var2; (float) var15 < (!var5 ? (float) (var11 + var3)
                        : (float) var11 + var2); var15++) {
                    double var16 = (var10 - var13) * (var10 - var13) + (var12 - var14) * (var12 - var14)
                            + (!var5 ? 0 : (var11 - var15) * (var11 - var15));
                    if (var16 < (double) (var2 * var2)
                            && (!var4 || !(var16 < (double) ((var2 - 1.0F) * (var2 - 1.0F))))) {
                                ...
                                if (mc.player.canAttack((LivingEntity) var6)) {
                                    if (!(var6 instanceof ArmorStandEntity)) {
                                        if (!this.getBooleanValueFromSettingName("Players")
                                            ...
                                            var5.remove();
                                        } else if (var6 instanceof PlayerEntity
