...
public class NCPLongJump extends Module {
    ...
    public void onDisable() {
        ...
        MovementUtil.strafe(MovementUtil.method37076() * 0.7);
    }
    ...
    public void method16122(EventMove var1) {
        if (this.isEnabled() && mc.player != null) {
            if (mc.player.isOnGround()) {
                ...
                this.field23477 = 0;
                if (this.field23479) {
                    double var5 = MovementUtil.method37076() * 0.95;
                    if (this.field23478 == 1) {
                        this.field23480 = (double) this.getNumberValueBySettingName("Boost") * 0.4 + (double) MovementUtil.method37078() * 0.05;
    ...
    public void method16123(JumpEvent var1) {
        if (this.isEnabled() && mc.player != null) {
            ...
            var1.method14002(0.425 + (double) MovementUtil.method37079() * 0.1);
            if (this.getStringSettingValueByName("Glide Mode").equals("High") && MovementUtil.method37079() == 0) {
                var1.method14002(0.599);
                var1.method14003(0.0);
                if ((double) this.getNumberValueBySettingName("Boost") > 1.5) {
                    var1.method14003(0.28 + (double) this.getNumberValueBySettingName("Boost") * 0.1 + (double) MovementUtil.method37078() * 0.05);
                }
