...
public class AACSpeed extends Module {
   ...
   public void onEnable() {
      ...
      this.field23404 = MovementUtil.method37083()[0];
      this.field23400 = 0;
   }

   @Override
   public void onDisable() {
      MovementUtil.method37093(0.27, MovementUtil.method37083()[0], this.field23404, 45.0F);
   }
   ...
   public void method16009(EventMove var1) {
      if (this.isEnabled()) {
         ...
         if (this.field23398 >= 0) {
            this.field23404 = MovementUtil.method37092(var1, this.field23401, MovementUtil.method37083()[0], this.field23404, 45.0F);
         }
