...
public class HypixelSpeed extends Module {
    ...
    public void onDisable() {
        if (this.field23418 == Class2094.field13641 && mc.player.getMotion().y > 0.0 && this.field23414 == 0) {
            MultiUtilities.setPlayerYMotion(-MovementUtil.method37080() - 1.0E-5 - 0.0625);
        }
            ...
            if (mc.player.onGround) {
                ...
                if (this.field23414 >= 0 && Step.field23887 >= 2) {
                    if ((var1.getY() > 0.0 || this.getBooleanValueFromSettingName("AutoJump") && MultiUtilities.method17686()) && !MultiUtilities.method17684(mc.player)) {
                        ...
                        MovementUtil.setSpeed(var1, 0.644348756324588 + Math.random() * 1.0E-6 + (double) MovementUtil.method37078() * 0.13);
                        ...
                        mc.player.jump();
                        var1.setY(0.399 + (double) MovementUtil.method37079() * 0.1 + 1.0E-14);
                        MovementUtil.setSpeed(var1, 0.51 + Math.random() * 1.0E-6 + (double) MovementUtil.method37078() * 0.098);
                        this.field23414 = 0;
                        if (this.getBooleanValueFromSettingName("Timer") && !Client.getInstance().moduleManager.getModuleByClass(Timer.class).isEnabled()) {
                ...
                switch (Class7845.field33649[this.field23418.ordinal()]) {
                    case 1:
                        if (this.field23414 == 0) {
                            this.field23415 = 0.3893478969348657 + Math.random() * 1.0E-6 + (double) MovementUtil.method37078() * 0.077;
                        } else {
                            double var8 = 0.99375 - (double) this.field23414 * 1.0E-13;
                            this.field23415 *= var8;
                        }

                        if (MovementUtil.method37079() == 0 && !Client.getInstance().moduleManager.getModuleByClass(BlockFly.class).isEnabled()) {
                    ...
                    case 2:
                        if (this.field23414 == 0) {
                            ...
                            if (this.getBooleanValueFromSettingName("BorderJump")
                                ...
                                this.field23415 = 0.3 + Math.random() * 1.0E-6 + (double) MovementUtil.method37078() * 0.067;
                            }
