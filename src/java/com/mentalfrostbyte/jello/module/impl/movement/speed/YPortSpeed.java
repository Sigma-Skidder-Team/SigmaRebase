...
public class YPortSpeed extends Module {
    ...
    public void onDisable() {
        ...
        if (mc.player.getMotion().y > 0.33) {
            MultiUtilities.setPlayerYMotion(-0.43 + (double) MovementUtil.method37079() * 0.1);
                ...
                switch (var4) {
                    case "NCP":
                        if (MovementUtil.isMoving() && mc.player.isOnGround()) {
                            ...
                            mc.player.stepHeight = 0.5F;
                                ...
                                && MultiUtilities.isAboveBounds(mc.player, (float) (MovementUtil.method37080() + (double) MovementUtil.method37079() * 0.1 + 0.001F))) {
                            this.field23541 = !this.field23541;
                            MovementUtil.setSpeed(var1, 0.312);
                            var1.setY(-0.43 + (double) MovementUtil.method37079() * 0.1);
                    ...
                    case "OldNCP":
                        ...
                        if (this.field23545 == 1 && MultiUtilities.method17686()) {
                            ...
                            var8 *= 1.0 + Math.sqrt((float) MovementUtil.method37079() / 2.0F) / 2.0;
                            var1.setY(var8);
