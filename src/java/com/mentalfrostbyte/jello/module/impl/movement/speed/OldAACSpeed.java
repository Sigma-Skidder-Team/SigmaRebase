...
public class OldAACSpeed extends Module {
    ...
    public void onEnable() {
        ...
        this.field23535 = MovementUtil.method37083()[0];
    }
        ...
        if (this.isEnabled()) {
            if (!mc.player.onGround) {
                if (MultiUtilities.method17686() && AACAntiKB.ticks >= 7) {
                    ...
                    this.field23535 = MovementUtil.method37092(var1, this.field23534, MovementUtil.method37083()[0], this.field23535, 45.0F);
                }
            ...
            } else if (var1.getY() != 0.4 + (double) MovementUtil.method37079() * 0.1) {
                this.field23537 = 0;
            } else {
    ...
    public void method16227(JumpEvent var1) {
        if (this.isEnabled()) {
            ...
            var1.method14002(0.4 + (double) MovementUtil.method37079() * 0.1);
            this.field23536 = 0;
        }
    }
