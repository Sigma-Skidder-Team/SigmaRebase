...
public class GommeSpeed extends Module {
    ...
    public void onEnable() {
        this.field23581 = 0;
        this.field23582 = 0;
        this.field23584 = MovementUtil.method37083()[0];
    }

    @Override
    public void onDisable() {
        if (MultiUtilities.method17686()) {
            MovementUtil.method37093(0.27, MovementUtil.method37083()[0], this.field23584, 45.0F);
        } else {
        ...
        if (this.isEnabled()) {
            if (!mc.player.isOnGround()) {
                if (this.field23583 > 0.0 && this.field23582 > 0) {
                    ...
                    if (MultiUtilities.method17686()) {
                        this.field23584 = MovementUtil.method37092(var1, Math.max(this.field23583, 0.23), MovementUtil.method37083()[0], this.field23584, 45.0F);
                    } else {
                        this.field23583 = 0.1;
