        ...
        if (this.grounded) {
            ...
            switch (curMode) {
                case "Basic":
                    ...
                    break;
                case "Fast":
                    event.setY(MovementUtil.method37080());
                    MovementUtil.setSpeed(event, var28);
                    this.grounded = !this.grounded;
                    this.flySpeed = 0.51 + (double) this.getNumberValueBySettingName("Speed") + 0.015 * (double) MovementUtil.method37078();
                    break;
                case "NoDmg":
                    event.setY(MovementUtil.method37080());
                    MovementUtil.setSpeed(event, var28);
