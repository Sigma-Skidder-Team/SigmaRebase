...
public class Class7339 {
    ...
    static {
        try {
            field31444[Mirror.LEFT_RIGHT.ordinal()] = 1;
        } catch (NoSuchFieldError var10) {
        }

        try {
            field31444[Mirror.FRONT_BACK.ordinal()] = 2;
        ...
        try {
            field31442[RedstoneSide.UP.ordinal()] = 1;
        } catch (NoSuchFieldError var5) {
        }

        try {
            field31442[RedstoneSide.SIDE.ordinal()] = 2;
        } catch (NoSuchFieldError var4) {
        }

        try {
            field31442[RedstoneSide.NONE.ordinal()] = 3;
