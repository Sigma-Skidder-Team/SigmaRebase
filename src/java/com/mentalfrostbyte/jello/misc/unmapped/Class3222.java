...
//        // todo: this makes no sense, it has to be something else.
////        this function isn't used anyways, so commenting it out.
//        return MathHelper.rgb(var3.getX(), var3.getY(), var3.getZ());
//    }
    ...
    private void method11630(World var1, Random var2, BlockPos var3, Vector3f var4, Direction var5, Direction var6, float var7, float var8) {
        ...
        if (!(var2.nextFloat() >= 0.2F * var11)) {
            ...
            var1.addParticle(
                    new RedstoneParticleData(var4.getX(), var4.getY(), var4.getZ(), 1.0F),
