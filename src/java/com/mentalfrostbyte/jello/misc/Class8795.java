...
public class Class8795 {
    ...
    public void method31753(double var1, double var3, double var5, String var7) {
        ...
        GL11.glPushMatrix();
        GL11.glTranslated(
                var1 - this.mc.gameRenderer.getActiveRenderInfo().getRenderViewEntity().getPosX() + 0.5,
                var3 - this.mc.gameRenderer.getActiveRenderInfo().getRenderViewEntity().getPosY(),
                var5 - this.mc.gameRenderer.getActiveRenderInfo().getRenderViewEntity().getPosZ() + 0.5
        );
        GL11.glAlphaFunc(519, 0.0F);
        ...
        com.mentalfrostbyte.jello.util.unmapped.ClientResource var10 = com.mentalfrostbyte.jello.util.ResourceRegistry.JelloLightFont25;
        GL11.glPushMatrix();
