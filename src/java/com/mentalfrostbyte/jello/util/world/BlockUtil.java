...
import com.mentalfrostbyte.jello.misc.EntityDistanceComparator;
import com.mentalfrostbyte.jello.misc.HolyShitBlock;
import com.mentalfrostbyte.jello.misc.PlayerEntityDistanceComparator;
...
public class BlockUtil {
    ...
    public static boolean method34538(Block var0, BlockPos var1) {
        VoxelShape shape = var0.getDefaultState().getShape(mc.world, var1);
        return !method34578(var1)
                && mc.world.checkNoEntityCollision(mc.player, shape)
    ...
    public static void method34539(BlockPos var0) {
        ...
        double var5 = (double) var0.getY() + 0.5
        ...
        Minecraft.getInstance()
                ...
                .sendPacket(
                        new CPlayerPacket.RotationPacket(
                                Minecraft.getInstance().player.rotationYaw
                                        + MathHelper.wrapDegrees(var11 - Minecraft.getInstance().player.rotationYaw),
    ...
    public static float[] method34541(BlockPos var0) {
        double var3 = (double) var0.getX() + 0.5 - Minecraft.getInstance().player.getPosX();
        double var5 = (double) var0.getY() - 0.25
                - (Minecraft.getInstance().player.getPosY() + (double) Minecraft.getInstance().player.getEyeHeight());
        double var7 = (double) var0.getZ() + 0.5 - Minecraft.getInstance().player.getPosZ();
        double var9 = (double) MathHelper.sqrt(var3 * var3 + var7 * var7);
        float var11 = (float) (Math.atan2(var7, var3) * 180.0 / Math.PI) - 90.0F;
    ...
    public static float[] method34542(BlockPos var0, Direction var1) {
        ...
        float var5 = 0.0F;
        float var6 = 0.0F;
        switch (Directions.directions[var1.ordinal()]) {
            case 1:
                var4 += 0.49F;
                break;
            case 2:
        ...
        return new float[] {
                Minecraft.getInstance().player.rotationYaw
                        + MathHelper.wrapDegrees(var15 - Minecraft.getInstance().player.rotationYaw),
                Minecraft.getInstance().player.rotationPitch
                        + MathHelper.wrapDegrees(var16 - Minecraft.getInstance().player.rotationPitch)
        };
    }
    ...
    public static float method34544(BlockPos var0, Direction var1) {
        ...
        double var10 = (double) var0.getY()
                ...
                - (Minecraft.getInstance().player.getPosY() + (double) Minecraft.getInstance().player.getEyeHeight())
                + 1.0;
        double var12 = (double) var0.getY() - 0.02
                - (Minecraft.getInstance().player.getPosY() + (double) Minecraft.getInstance().player.getEyeHeight());
    ...
    public static List<Entity> getVisibleEntities(List<Entity> var0) {
        Collections.sort(var0, new EntityDistanceComparator());
        return var0;
    }

    public static List<PlayerEntity> method34549(List<PlayerEntity> var0) {
        Collections.sort(var0, new PlayerEntityDistanceComparator());
        return var0;
    }
    ...
    private static float method34558(float var0, float var1, float var2) {
        return MathHelper
                .sqrt((var0 - 0.5F) * (var0 - 0.5F) + (var1 - 0.5F) * (var1 - 0.5F) + (var2 - 0.5F) * (var2 - 0.5F));
    }
        ...
        for (float var5 = -var3; var5 <= var3; var5++) {
            for (float var6 = -var4; var6 <= var4; var6++) {
                for (float var7 = -var4; var7 <= var4; var7++) {
                    ...
                    if (mc.world.getBlockState(var8).getBlock() instanceof HolyShitBlock) {
                        var2.add(var8);
                    }
                }
            }
        ...
        if (var2.getType() != RayTraceResult.Type.MISS) {
            ...
            double var11 = (double) var2.getPos().getY()
                    - (Minecraft.getInstance().player.getPosY()
                            + (double) Minecraft.getInstance().player.getEyeHeight())
                    + var7;
            ...
            return new float[] {
                    Minecraft.getInstance().player.rotationYaw
                            + MathHelper.wrapDegrees(var17 - Minecraft.getInstance().player.rotationYaw),
                    Minecraft.getInstance().player.rotationPitch
                            + MathHelper.wrapDegrees(var18 - Minecraft.getInstance().player.rotationPitch)
            };
        } else {
            return null;
        }
    ...
    public static BlockRayTraceResult method34566(float var0) {
        ...
        return mc.world.rayTraceBlocks(new RayTraceContext(var3, var8, RayTraceContext.BlockMode.OUTLINE,
                RayTraceContext.FluidMode.NONE, var9));
    }
    ...
    public static BlockRayTraceResult rayTrace(float var0, float var1, float var2) {
        ...
        return mc.world.rayTraceBlocks(new RayTraceContext(var5, var9, RayTraceContext.BlockMode.OUTLINE,
                RayTraceContext.FluidMode.NONE, var10));
    }
    ...
    public static BlockRayTraceResult method34568(float var0, float var1, float var2, EventUpdate var3) {
        ...
        return mc.world.rayTraceBlocks(new RayTraceContext(var6, var10, RayTraceContext.BlockMode.OUTLINE,
                RayTraceContext.FluidMode.NONE, var11));
    }
    ...
    public static RayTraceResult method34569(float var0, float var1, float var2, float var3) {
        ...
        return mc.world.rayTraceBlocks(new RayTraceContext(var10, var14, RayTraceContext.BlockMode.OUTLINE,
                RayTraceContext.FluidMode.NONE, var15));
    }
    ...
    public static RayTraceResult method34570(BlockPos var0) {
        ...
        return mc.world.rayTraceBlocks(new RayTraceContext(var3, var4, RayTraceContext.BlockMode.OUTLINE,
                RayTraceContext.FluidMode.NONE, mc.getRenderViewEntity()));
    }
    ...
    private boolean method34571(PositionFacing var1, float var2, float var3) {
        ...
        BlockRayTraceResult var13 = mc.world.rayTraceBlocks(new RayTraceContext(var6, var11,
                RayTraceContext.BlockMode.OUTLINE, RayTraceContext.FluidMode.ANY, var12));
    ...
    public static Vector3d method34572(Direction var0, BlockPos var1) {
        ...
        float var7 = (float) var1.getY()
                + (var0.getYOffset() != 0 ? 0.0F : (var0.getYOffset() != 1 ? (float) Math.random() : 1.0F));
    ...
    public static Class7843 method34575(BlockPos var0, boolean var1) {
        Vector3i[] var4 = new Vector3i[] {
                new Vector3i(0, 0, 0), new Vector3i(-1, 0, 0), new Vector3i(1, 0, 0), new Vector3i(0, 0, 1),
                new Vector3i(0, 0, -1)
        };
        ...
        for (Class7306 var9 : var5) {
            for (Vector3i var13 : var4) {
                Vector3i var14 = !var9.field31325
                        ? new Vector3i(var13.getX() * var9.field31322, var13.getY() * var9.field31323,
                                var13.getZ() * var9.field31324)
                        : new Vector3i(var13.getX() + var9.field31322, var13.getY() + var9.field31323,
                                var13.getZ() + var9.field31324);

                for (Direction var18 : Direction.values()) {
                    if ((var18 != Direction.DOWN || !var1)
                            && method34578(var0.method8337(var14).method8350(var18, -1))) {
    ...
    public static Class7843 method34577(BlockPos var0, boolean var1, boolean var2) {
        ...
        for (BlockPos var8 : method34547(
            ...
            for (Direction var12 : Direction.values()) {
                if ((var12 != Direction.DOWN || !var1) && !method34578(var8)
                        && method34578(var8.method8350(var12, -1))) {
    ...
    public static float[] method34579(float var0, float var1, Class7843 var2) {
        ...
        if (var5 != null && var5.getPos().equals(var2.field33646)) {
            ...
            Vector3d var7 = new Vector3d(
                    (double) var2.field33646.getX() + 0.5, (double) var2.field33646.getY() + 0.5,
                    (double) var2.field33646.getZ() + 0.5);
            ...
            float var18 = var16[1];
            float var19 = Math
                    .abs(RotationHelper.method34142(MathHelper.wrapDegrees(var0), MathHelper.wrapDegrees(var14)));
            float var20 = Math
                    .abs(RotationHelper.method34142(MathHelper.wrapDegrees(var0), MathHelper.wrapDegrees(var17)));
    ...
    public static Direction method34580(BlockPos var0) {
        ...
        if (MathHelper.wrapDegrees(method34581(var0, Direction.UP)[1]) > 75.0F
                || MathHelper.wrapDegrees(method34581(var0, Direction.UP)[1]) < -75.0F) {
            var3 = Direction.UP;
        }
    ...
    private float method34582(Entity var1, BlockPos var2) {
        ...
        if (!var1.method3398()) {
            double var11 = (double) (MathHelper.sqrt(var1.getDistanceSq3(var10)) / var9);
            if (var11 <= 1.0) {
