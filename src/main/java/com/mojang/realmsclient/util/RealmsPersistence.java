...
public class RealmsPersistence {
    ...
    public static RealmsPersistence.RealmsPersistenceData func_225188_a() {
        ...
        try {
            return field_238092_a_.func_237695_a_(FileUtils.readFileToString(file1, StandardCharsets.UTF_8),
                    RealmsPersistence.RealmsPersistenceData.class);
    ...
    private static File func_238093_b_() {
        return new File(MinecraftClient.getInstance().gameDir, "realms_persistence.json");
    }
