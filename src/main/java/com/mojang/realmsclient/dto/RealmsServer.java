...
public class RealmsServer extends ValueObject {
    ...
    public void func_230772_a_(RealmsServerPlayerList p_230772_1_) {
        ...
        for (String s : p_230772_1_.field_230610_b_) {
            if (!s.equals(MinecraftClient.getInstance().getSession().getPlayerID())) {
                String s1 = "";
    ...
    public static RealmsServer func_230770_a_(JsonObject p_230770_0_) {
        ...
        try {
            ...
            realmsserver.field_230586_e_ = func_230780_d_(
                    JsonUtils.func_225171_a("state", p_230770_0_, RealmsServer.Status.CLOSED.name()));
            ...
            realmsserver.field_230594_m_ = func_230781_e_(
                    JsonUtils.func_225171_a("worldType", p_230770_0_, RealmsServer.ServerType.NORMAL.name()));
    ...
    private static void func_230771_a_(RealmsServer p_230771_0_) {
        p_230771_0_.field_230589_h_.sort((p_229951_0_, p_229951_1_) -> {
            return ComparisonChain.start().compareFalseFirst(p_229951_1_.func_230765_d_(), p_229951_0_.func_230765_d_())
                    .compare(p_229951_0_.func_230757_a_().toLowerCase(Locale.ROOT),
                            p_229951_1_.func_230757_a_().toLowerCase(Locale.ROOT))
                    .result();
        });
    }
    ...
    public int hashCode() {
        return Objects.hash(this.field_230582_a_, this.field_230584_c_, this.field_230585_d_, this.field_230586_e_,
                this.field_230587_f_, this.field_230591_j_);
    }
    ...
    public boolean equals(Object p_equals_1_) {
        if (p_equals_1_ == null) {
            ...
            return (new EqualsBuilder()).append(this.field_230582_a_, realmsserver.field_230582_a_)
                    .append((Object) this.field_230584_c_, (Object) realmsserver.field_230584_c_)
                    .append((Object) this.field_230585_d_, (Object) realmsserver.field_230585_d_)
                    .append((Object) this.field_230586_e_, (Object) realmsserver.field_230586_e_)
                    .append((Object) this.field_230587_f_, (Object) realmsserver.field_230587_f_)
                    .append(this.field_230591_j_, realmsserver.field_230591_j_)
                    .append((Object) this.field_230594_m_, (Object) this.field_230594_m_).isEquals();
        }
    }
    ...
    public static class ServerComparator implements Comparator<RealmsServer> {
        ...
        public int compare(RealmsServer p_compare_1_, RealmsServer p_compare_2_) {
            return ComparisonChain.start()
                    .compareTrueFirst(p_compare_1_.field_230586_e_ == RealmsServer.Status.UNINITIALIZED,
                            p_compare_2_.field_230586_e_ == RealmsServer.Status.UNINITIALIZED)
                    .compareTrueFirst(p_compare_1_.field_230592_k_, p_compare_2_.field_230592_k_)
                    .compareTrueFirst(p_compare_1_.field_230587_f_.equals(this.field_223701_a),
                            p_compare_2_.field_230587_f_.equals(this.field_223701_a))
                    .compareFalseFirst(p_compare_1_.field_230591_j_, p_compare_2_.field_230591_j_)
                    .compareTrueFirst(p_compare_1_.field_230586_e_ == RealmsServer.Status.OPEN,
                            p_compare_2_.field_230586_e_ == RealmsServer.Status.OPEN)
                    .compare(p_compare_1_.field_230582_a_, p_compare_2_.field_230582_a_).result();
        }
    }
