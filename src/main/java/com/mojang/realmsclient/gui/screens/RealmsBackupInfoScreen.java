...
public class RealmsBackupInfoScreen extends RealmsScreen {
    ...
    public void init() {
        ...
        this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 120 + 24, 200, 20, DialogTexts.GUI_BACK,
                (p_237731_1_) -> {
    ...
    private ITextComponent func_237733_a_(String p_237733_1_, String p_237733_2_) {
        ...
        if (s.contains("game") && s.contains("mode")) {
            ...
            return (ITextComponent) (s.contains("game") && s.contains("difficulty") ? this.func_237732_a_(p_237733_2_)
                    : new StringTextComponent(p_237733_2_));
        }
    }
    ...
    class BackupInfoEntry extends ExtendedList.AbstractListEntry<RealmsBackupInfoScreen.BackupInfoEntry> {
        ...
        public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_,
            ...
            AbstractGui.drawString(p_230432_1_, fontrenderer,
                    RealmsBackupInfoScreen.this.func_237733_a_(this.field_237738_b_, this.field_237739_c_), p_230432_4_,
                    p_230432_3_ + 12, 16777215);
        }
    }
    ...
    class BackupInfoList extends ExtendedList<RealmsBackupInfoScreen.BackupInfoEntry> {
        public BackupInfoList(Minecraft p_i232198_2_) {
            super(p_i232198_2_, RealmsBackupInfoScreen.this.width, RealmsBackupInfoScreen.this.height, 32,
                    RealmsBackupInfoScreen.this.height - 64, 36);
