...
public class RealmsServerSlotButton extends Button implements IScreen {
    public static final ResourceLocation field_237712_a_ = new ResourceLocation("realms",
            "textures/gui/realms/slot_frame.png");
    public static final ResourceLocation field_237713_b_ = new ResourceLocation("realms",
            "textures/gui/realms/empty_frame.png");
    public static final ResourceLocation field_237714_c_ = new ResourceLocation("minecraft",
            "textures/gui/title/background/panorama_0.png");
    public static final ResourceLocation field_237715_d_ = new ResourceLocation("minecraft",
            "textures/gui/title/background/panorama_2.png");
    public static final ResourceLocation field_237716_e_ = new ResourceLocation("minecraft",
            "textures/gui/title/background/panorama_3.png");
    private static final ITextComponent field_243091_v = new TranslationTextComponent(
            "mco.configure.world.slot.tooltip.active");
    private static final ITextComponent field_243092_w = new TranslationTextComponent(
            "mco.configure.world.slot.tooltip.minigame");
    private static final ITextComponent field_243093_x = new TranslationTextComponent(
    ...
    public RealmsServerSlotButton(int p_i232195_1_, int p_i232195_2_, int p_i232195_3_, int p_i232195_4_,
            Supplier<RealmsServer> p_i232195_5_, Consumer<ITextComponent> p_i232195_6_, int p_i232195_7_,
            Button.IPressable p_i232195_8_) {
    ...
    public void tick() {
        ...
        if (realmsserver != null) {
            ...
            if (flag2) {
                ...
                flag = realmsserver.field_230595_n_ == this.field_223776_d
                        && realmsserver.field_230594_m_ != RealmsServer.ServerType.MINIGAME;
            ...
            Pair<ITextComponent, ITextComponent> pair = this.func_237719_a_(realmsserver, s, flag1, flag2,
                    realmsserverslotbutton$action);
            this.field_223778_f = new RealmsServerSlotButton.ServerData(flag, s, i, s1, flag1, flag2,
                    realmsserverslotbutton$action, pair.getFirst());
            this.setMessage(pair.getSecond());
        }
    }

    private static RealmsServerSlotButton.Action func_237720_a_(RealmsServer p_237720_0_, boolean p_237720_1_,
            boolean p_237720_2_) {
        if (p_237720_1_) {
    ...
    private Pair<ITextComponent, ITextComponent> func_237719_a_(RealmsServer p_237719_1_, String p_237719_2_,
            boolean p_237719_3_, boolean p_237719_4_, RealmsServerSlotButton.Action p_237719_5_) {
        if (p_237719_5_ == RealmsServerSlotButton.Action.NOTHING) {
            ...
            if (p_237719_4_) {
                if (p_237719_3_) {
                    ...
                    itextcomponent = (new StringTextComponent(" ")).appendString(p_237719_2_).appendString(" ")
                            .appendString(p_237719_1_.field_230596_o_);
                }
            } else {
    ...
    public void renderButton(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        if (this.field_223778_f != null) {
            this.func_237718_a_(matrixStack, this.x, this.y, mouseX, mouseY, this.field_223778_f.field_225110_a,
                    this.field_223778_f.field_225111_b, this.field_223776_d, this.field_223778_f.field_225112_c,
                    this.field_223778_f.field_225113_d, this.field_223778_f.field_225114_e,
                    this.field_223778_f.field_225115_f, this.field_223778_f.field_225116_g,
                    this.field_223778_f.field_225117_h);
        }
    }
    ...
    private void func_237718_a_(MatrixStack p_237718_1_, int p_237718_2_, int p_237718_3_, int p_237718_4_,
            ...
            @Nullable String p_237718_11_, boolean p_237718_12_, boolean p_237718_13_,
            RealmsServerSlotButton.Action p_237718_14_, @Nullable ITextComponent p_237718_15_) {
        ...
        drawCenteredString(p_237718_1_, minecraft.fontRenderer, p_237718_7_, p_237718_2_ + 40, p_237718_3_ + 66,
                16777215);
    }
    ...
    public static class ServerData {
        ...
        ServerData(boolean p_i232196_1_, String p_i232196_2_, long p_i232196_3_, @Nullable String p_i232196_5_,
                boolean p_i232196_6_, boolean p_i232196_7_, RealmsServerSlotButton.Action p_i232196_8_,
                @Nullable ITextComponent p_i232196_9_) {
