...
public class RealmsMainScreen extends RealmsScreen {
    ...
    private static final ResourceLocation field_237540_b_ = new ResourceLocation("realms",
            "textures/gui/realms/on_icon.png");
    private static final ResourceLocation field_237541_c_ = new ResourceLocation("realms",
            "textures/gui/realms/off_icon.png");
    private static final ResourceLocation field_237542_p_ = new ResourceLocation("realms",
            "textures/gui/realms/expired_icon.png");
    private static final ResourceLocation field_237543_q_ = new ResourceLocation("realms",
            "textures/gui/realms/expires_soon_icon.png");
    private static final ResourceLocation field_237544_r_ = new ResourceLocation("realms",
            "textures/gui/realms/leave_icon.png");
    private static final ResourceLocation field_237545_s_ = new ResourceLocation("realms",
            "textures/gui/realms/invitation_icons.png");
    private static final ResourceLocation field_237546_t_ = new ResourceLocation("realms",
            "textures/gui/realms/invite_icon.png");
    private static final ResourceLocation field_237547_u_ = new ResourceLocation("realms",
            "textures/gui/realms/world_icon.png");
    private static final ResourceLocation field_237548_v_ = new ResourceLocation("realms",
            "textures/gui/title/realms.png");
    private static final ResourceLocation field_237549_w_ = new ResourceLocation("realms",
            "textures/gui/realms/configure_icon.png");
    private static final ResourceLocation field_237550_x_ = new ResourceLocation("realms",
            "textures/gui/realms/questionmark.png");
    private static final ResourceLocation field_237551_y_ = new ResourceLocation("realms",
            "textures/gui/realms/news_icon.png");
    private static final ResourceLocation field_237552_z_ = new ResourceLocation("realms",
            "textures/gui/realms/popup.png");
    private static final ResourceLocation field_237534_A_ = new ResourceLocation("realms",
            "textures/gui/realms/darken.png");
    private static final ResourceLocation field_237535_B_ = new ResourceLocation("realms",
            "textures/gui/realms/cross_icon.png");
    private static final ResourceLocation field_237536_C_ = new ResourceLocation("realms",
            "textures/gui/realms/trial_icon.png");
    private static final ResourceLocation field_237537_D_ = new ResourceLocation("minecraft",
    ...
    private static final List<ITextComponent> field_243002_G = ImmutableList.of(
            new TranslationTextComponent("mco.trial.message.line1"),
            new TranslationTextComponent("mco.trial.message.line2"));
    ...
    private static final ITextComponent field_243007_L = new TranslationTextComponent(
            "mco.selectServer.expiredSubscribe");
    private static final ITextComponent field_243008_M = (new TranslationTextComponent("mco.selectServer.minigame"))
            .appendString(" ");
        ...
        if (func_223968_l() && this.field_224034_w) {
            if (this.field_224037_z && !this.field_223993_A) {
                ...
                for (RealmsServer realmsserver : this.field_224028_q) {
                    if (realmsserver.field_230588_g_.equals(this.minecraft.getSession().getPlayerID())) {
                        return false;
                    }
                }
    ...
    public boolean func_223990_b() {
        if (func_223968_l() && this.field_224034_w) {
            if (this.field_224035_x) {
                ...
                return this.field_224037_z && !this.field_223993_A && this.field_224028_q.isEmpty() ? true
                        : this.field_224028_q.isEmpty();
            }
        } else {
            return false;
        }
    ...
    public void func_223901_c() {
        this.field_224026_o = this.addButton(new Button(this.width / 2 - 202, this.height - 32, 90, 20,
                new TranslationTextComponent("mco.selectServer.leave"), (p_237624_1_) -> {
                    this.func_223906_g(this.func_223967_a(this.field_224021_j));
                }));
        this.field_224025_n = this.addButton(new Button(this.width / 2 - 190, this.height - 32, 90, 20,
                new TranslationTextComponent("mco.selectServer.configure"), (p_237637_1_) -> {
                    this.func_223966_f(this.func_223967_a(this.field_224021_j));
                }));
        this.field_224022_k = this.addButton(new Button(this.width / 2 - 93, this.height - 32, 90, 20,
                new TranslationTextComponent("mco.selectServer.play"), (p_237635_1_) -> {
        ...
        this.field_224023_l = this.addButton(
                new Button(this.width / 2 + 4, this.height - 32, 90, 20, DialogTexts.GUI_BACK, (p_237632_1_) -> {
                    if (!this.field_224036_y) {
                        this.minecraft.displayGuiScreen(this.field_224019_h);
                    }
                }));
        this.field_224024_m = this.addButton(new Button(this.width / 2 + 100, this.height - 32, 90, 20,
                new TranslationTextComponent("mco.selectServer.expiredRenew"), (p_237629_1_) -> {
                    this.func_223930_q();
                }));
        ...
        this.field_224009_Q = this.addButton(new Button(this.width / 2 + 52, this.func_223932_C() + 137 - 20, 98, 20,
                new TranslationTextComponent("mco.selectServer.trial"), (p_237618_1_) -> {
                    if (this.field_224037_z && !this.field_223993_A) {
                        Util.getOSType().openURI("https://aka.ms/startjavarealmstrial");
                        this.minecraft.displayGuiScreen(this.field_224019_h);
                    }
                }));
        this.field_224010_R = this.addButton(new Button(this.width / 2 + 52, this.func_223932_C() + 160 - 20, 98, 20,
                new TranslationTextComponent("mco.selectServer.buy"), (p_237612_0_) -> {
    ...
    private boolean func_223897_b(@Nullable RealmsServer p_223897_1_) {
        return p_223897_1_ != null && !p_223897_1_.field_230591_j_
                && p_223897_1_.field_230586_e_ == RealmsServer.Status.OPEN;
    }
            ...
            if (field_224017_f.func_225083_a(RealmsDataFetcher.Task.PENDING_INVITE)) {
                ...
                if (this.field_224029_r > 0 && this.field_224014_c.tryAcquire(1)) {
                    RealmsNarratorHelper
                            .func_239550_a_(I18n.format("mco.configure.world.invite.narration", this.field_224029_r));
                }
            }
    ...
    private void func_223930_q() {
        ...
        if (realmsserver != null) {
            String s = "https://aka.ms/ExtendJavaRealms?subscriptionId=" + realmsserver.field_230583_b_ + "&profileId="
                    + this.minecraft.getSession().getPlayerID() + "&ref="
                    + (realmsserver.field_230592_k_ ? "expiredTrial" : "expiredRealm");
        ...
        if (!field_224033_v) {
            ...
            (new Thread("MCO Compatability Checker #1") {
                public void run() {
                    ...
                    try {
                        RealmsClient.CompatibleVersionResponse realmsclient$compatibleversionresponse = realmsclient
                                .func_224939_i();

                        if (realmsclient$compatibleversionresponse == RealmsClient.CompatibleVersionResponse.OUTDATED) {
                            RealmsMainScreen.field_224000_H = new RealmsClientOutdatedScreen(
                                    RealmsMainScreen.this.field_224019_h, true);
                            RealmsMainScreen.this.minecraft.execute(() -> {
                                RealmsMainScreen.this.minecraft.displayGuiScreen(RealmsMainScreen.field_224000_H);
                            });
                            return;
                        }
                        ...
                        if (realmsclient$compatibleversionresponse == RealmsClient.CompatibleVersionResponse.OTHER) {
                            RealmsMainScreen.field_224000_H = new RealmsClientOutdatedScreen(
                                    RealmsMainScreen.this.field_224019_h, false);
                            RealmsMainScreen.this.minecraft.execute(() -> {
                                RealmsMainScreen.this.minecraft.displayGuiScreen(RealmsMainScreen.field_224000_H);
                            });
                            return;
                        ...
                        RealmsMainScreen.field_224012_a.error("Couldn't connect to realms",
                                (Throwable) realmsserviceexception);

                        if (realmsserviceexception.field_224981_a == 401) {
                            RealmsMainScreen.field_224000_H = new RealmsGenericErrorScreen(
                            ...
                            RealmsMainScreen.this.minecraft.execute(() -> {
                                RealmsMainScreen.this.minecraft.displayGuiScreen(new RealmsGenericErrorScreen(
                                        realmsserviceexception, RealmsMainScreen.this.field_224019_h));
                            });
                        }
                    }
                }
            ...
            public void run() {
                ...
                try {
                    ...
                    if (obool) {
                        ...
                        RealmsMainScreen.this.minecraft.execute(() -> {
                            RealmsMainScreen.this.minecraft.displayGuiScreen(
                                    new RealmsParentalConsentScreen(RealmsMainScreen.this.field_224019_h));
                        });
                    }
    ...
    private void func_223966_f(RealmsServer p_223966_1_) {
        if (this.minecraft.getSession().getPlayerID().equals(p_223966_1_.field_230588_g_) || field_224013_b) {
            this.func_223949_z();
            this.minecraft.displayGuiScreen(new RealmsConfigureWorldScreen(this, p_223966_1_.field_230582_a_));
        }
    }

    private void func_223906_g(@Nullable RealmsServer p_223906_1_) {
        if (p_223906_1_ != null && !this.minecraft.getSession().getPlayerID().equals(p_223906_1_.field_230588_g_)) {
            this.func_223949_z();
            ...
            this.minecraft.displayGuiScreen(new RealmsLongConfirmationScreen(this::func_237625_d_,
    ...
    private void func_237625_d_(boolean p_237625_1_) {
        if (p_237625_1_) {
            (new Thread("Realms-leave-server") {
                public void run() {
                    try {
                        RealmsServer realmsserver = RealmsMainScreen.this
                                .func_223967_a(RealmsMainScreen.this.field_224021_j);
                        ...
                        RealmsMainScreen.this.minecraft.execute(() -> {
                            RealmsMainScreen.this.minecraft.displayGuiScreen(
                                    new RealmsGenericErrorScreen(realmsserviceexception, RealmsMainScreen.this));
                        });
                    }
                }
            }).start();
    ...
    private void func_243059_h(RealmsServer p_243059_1_) {
        ...
        this.field_224020_i.getEventListeners().removeIf((p_243041_1_) -> {
            return p_243041_1_ instanceof RealmsMainScreen.ServerEntry
                    && ((RealmsMainScreen.ServerEntry) p_243041_1_).field_223734_a.field_230582_a_ == this.field_224021_j;
        });
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        if (this.field_224037_z && !this.field_223993_A && this.func_223990_b()) {
            ...
            AbstractGui.blit(matrices, this.field_224009_Q.x + this.field_224009_Q.getWidth() - 8 - 4,
                    this.field_224009_Q.y + this.field_224009_Q.getHeightRealms() / 2 - 4, 0.0F, (float) j, 8, 8, 8,
                    16);
        }
    }
    ...
    private boolean func_223979_a(double p_223979_1_, double p_223979_3_) {
        ...
        return p_223979_1_ < (double) (i - 5) || p_223979_1_ > (double) (i + 315) || p_223979_3_ < (double) (j - 5)
                || p_223979_3_ > (double) (j + 171);
    }
    ...
    private void func_237581_a_(MatrixStack p_237581_1_, int p_237581_2_, int p_237581_3_, int p_237581_4_,
            int p_237581_5_, boolean p_237581_6_, boolean p_237581_7_) {
        ...
        if (flag2) {
            ...
            int l = (int) (Math.max(0.0F, Math.max(MathHelper.sin((float) (10 + this.field_224030_s) * 0.57F),
                    MathHelper.cos((float) this.field_224030_s * 0.35F))) * -6.0F);
        ...
        if (flag4) {
            ...
            this.fillGradient(p_237581_1_, j1 - 3, p_237581_3_ - 3, j1 + i1 + 3, p_237581_3_ + 8 + 3, -1073741824,
                    -1073741824);
    ...
    private boolean func_223931_b(double p_223931_1_, double p_223931_3_) {
        ...
        return (double) i <= p_223931_1_ && p_223931_1_ <= (double) j && (double) k <= p_223931_3_
                && p_223931_3_ <= (double) l;
    }
    ...
    public void func_223911_a(RealmsServer p_223911_1_, Screen p_223911_2_) {
        if (p_223911_1_ != null) {
            ...
            this.minecraft.displayGuiScreen(new RealmsLongRunningMcoTaskScreen(p_223911_2_,
                    new ConnectingToRealmsAction(this, p_223911_2_, p_223911_1_, this.field_224004_L)));
        }
    }

    private boolean func_223885_h(RealmsServer p_223885_1_) {
        return p_223885_1_.field_230588_g_ != null
                && p_223885_1_.field_230588_g_.equals(this.minecraft.getSession().getPlayerID());
    }
    ...
    private void func_237614_c_(MatrixStack p_237614_1_, int p_237614_2_, int p_237614_3_, int p_237614_4_,
            int p_237614_5_) {
        ...
        if (p_237614_4_ >= p_237614_2_ && p_237614_4_ <= p_237614_2_ + 9 && p_237614_5_ >= p_237614_3_
                && p_237614_5_ <= p_237614_3_ + 27 && p_237614_5_ < this.height - 40 && p_237614_5_ > 32
                && !this.func_223990_b()) {
            this.func_237603_a_(field_243010_O);
        }
    }

    private void func_237606_b_(MatrixStack p_237606_1_, int p_237606_2_, int p_237606_3_, int p_237606_4_,
            int p_237606_5_, int p_237606_6_) {
        ...
        if (p_237606_4_ >= p_237606_2_ && p_237606_4_ <= p_237606_2_ + 9 && p_237606_5_ >= p_237606_3_
                && p_237606_5_ <= p_237606_3_ + 27 && p_237606_5_ < this.height - 40 && p_237606_5_ > 32
                && !this.func_223990_b()) {
            if (p_237606_6_ <= 0) {
    ...
    private void func_237620_d_(MatrixStack p_237620_1_, int p_237620_2_, int p_237620_3_, int p_237620_4_,
            int p_237620_5_) {
        ...
        if (p_237620_4_ >= p_237620_2_ && p_237620_4_ <= p_237620_2_ + 9 && p_237620_5_ >= p_237620_3_
                && p_237620_5_ <= p_237620_3_ + 27 && p_237620_5_ < this.height - 40 && p_237620_5_ > 32
                && !this.func_223990_b()) {
            this.func_237603_a_(field_243013_R);
        }
    }

    private void func_237626_e_(MatrixStack p_237626_1_, int p_237626_2_, int p_237626_3_, int p_237626_4_,
            int p_237626_5_) {
        ...
        if (p_237626_4_ >= p_237626_2_ && p_237626_4_ <= p_237626_2_ + 9 && p_237626_5_ >= p_237626_3_
                && p_237626_5_ <= p_237626_3_ + 27 && p_237626_5_ < this.height - 40 && p_237626_5_ > 32
                && !this.func_223990_b()) {
            this.func_237603_a_(field_243014_S);
        }
    }

    private void func_237630_f_(MatrixStack p_237630_1_, int p_237630_2_, int p_237630_3_, int p_237630_4_,
            int p_237630_5_) {
        boolean flag = false;

        if (p_237630_4_ >= p_237630_2_ && p_237630_4_ <= p_237630_2_ + 28 && p_237630_5_ >= p_237630_3_
                && p_237630_5_ <= p_237630_3_ + 28 && p_237630_5_ < this.height - 40 && p_237630_5_ > 32
                && !this.func_223990_b()) {
            flag = true;
        }
    ...
    private void func_237633_g_(MatrixStack p_237633_1_, int p_237633_2_, int p_237633_3_, int p_237633_4_,
            int p_237633_5_) {
        boolean flag = false;

        if (p_237633_4_ >= p_237633_2_ && p_237633_4_ <= p_237633_2_ + 28 && p_237633_5_ >= p_237633_3_
                && p_237633_5_ <= p_237633_3_ + 28 && p_237633_5_ < this.height - 40 && p_237633_5_ > 32
                && !this.func_223990_b()) {
            flag = true;
        }
    ...
    protected void func_237583_a_(MatrixStack p_237583_1_, List<ITextComponent> p_237583_2_, int p_237583_3_,
            int p_237583_4_) {
    ...
    private void func_237580_a_(MatrixStack p_237580_1_, int p_237580_2_, int p_237580_3_, int p_237580_4_,
            int p_237580_5_, boolean p_237580_6_) {
        boolean flag = false;

        if (p_237580_2_ >= p_237580_4_ && p_237580_2_ <= p_237580_4_ + 20 && p_237580_3_ >= p_237580_5_
                && p_237580_3_ <= p_237580_5_ + 20) {
            flag = true;
        }
    ...
    private void func_237582_a_(MatrixStack p_237582_1_, int p_237582_2_, int p_237582_3_, boolean p_237582_4_,
            int p_237582_5_, int p_237582_6_, boolean p_237582_7_, boolean p_237582_8_) {
        boolean flag = false;

        if (p_237582_2_ >= p_237582_5_ && p_237582_2_ <= p_237582_5_ + 20 && p_237582_3_ >= p_237582_6_
                && p_237582_3_ <= p_237582_6_ + 20) {
            flag = true;
        }
        ...
        if (p_237582_4_ && p_237582_8_) {
            int i = flag ? 0
                    : (int) (Math.max(0.0F, Math.max(MathHelper.sin((float) (10 + this.field_224030_s) * 0.57F),
                            MathHelper.cos((float) this.field_224030_s * 0.35F))) * -6.0F);
            this.minecraft.getTextureManager().bindTexture(field_237545_s_);
            RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
    ...
    public static void func_227932_a_(IResourceManager p_227932_0_) {
        Collection<ResourceLocation> collection = p_227932_0_.getAllResourceLocations("textures/gui/images",
                (p_227934_0_) -> {
    ...
    class CloseButton extends Button {
        public CloseButton() {
            super(RealmsMainScreen.this.func_223989_B() + 4, RealmsMainScreen.this.func_223932_C() + 4, 12, 12,
                    new TranslationTextComponent("mco.selectServer.close"), null);
        }
        ...
        public void renderButton(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
            RealmsMainScreen.this.minecraft.getTextureManager().bindTexture(RealmsMainScreen.field_237535_B_);
            RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
    ...
    class InfoButton extends Button {
        public InfoButton() {
            super(RealmsMainScreen.this.width - 37, 6, 20, 20, new TranslationTextComponent("mco.selectServer.info"),
                    null);
        }
    ...
    class NewsButton extends Button {
        ...
        public void onPress() {
            if (RealmsMainScreen.this.field_223996_D != null) {
                ...
                if (RealmsMainScreen.this.field_223995_C) {
                    RealmsPersistence.RealmsPersistenceData realmspersistence$realmspersistencedata = RealmsPersistence
                            .func_225188_a();
        ...
        public void renderButton(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
            RealmsMainScreen.this.func_237582_a_(matrixStack, mouseX, mouseY, RealmsMainScreen.this.field_223995_C,
                    this.x, this.y, this.isHovered(), this.active);
        }
    }
    ...
    class PendingInvitesButton extends Button implements IScreen {
        ...
        public void tick() {
            this.setMessage(new TranslationTextComponent(
                    RealmsMainScreen.this.field_224029_r == 0 ? "mco.invites.nopending" : "mco.invites.pending"));
        }

        public void renderButton(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
            RealmsMainScreen.this.func_237581_a_(matrixStack, mouseX, mouseY, this.x, this.y, this.isHovered(),
                    this.active);
        }
    }
    ...
    class ServerEntry extends RealmsMainScreen.ListEntry {
        ...
        public boolean mouseClicked(double mouseX, double mouseY, int button) {
            if (this.field_223734_a.field_230586_e_ == RealmsServer.Status.UNINITIALIZED) {
                ...
                RealmsMainScreen.this.minecraft
                        .displayGuiScreen(new RealmsCreateRealmScreen(this.field_223734_a, RealmsMainScreen.this));
            } else {
        ...
        private void func_237678_a_(RealmsServer p_237678_1_, MatrixStack p_237678_2_, int p_237678_3_, int p_237678_4_,
                int p_237678_5_, int p_237678_6_) {
            this.func_237679_b_(p_237678_1_, p_237678_2_, p_237678_3_ + 36, p_237678_4_, p_237678_5_, p_237678_6_);
        }

        private void func_237679_b_(RealmsServer p_237679_1_, MatrixStack p_237679_2_, int p_237679_3_, int p_237679_4_,
                int p_237679_5_, int p_237679_6_) {
            if (p_237679_1_.field_230586_e_ == RealmsServer.Status.UNINITIALIZED) {
                RealmsMainScreen.this.minecraft.getTextureManager().bindTexture(RealmsMainScreen.field_237547_u_);
                RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
                ...
                AbstractGui.drawCenteredString(p_237679_2_, RealmsMainScreen.this.font, RealmsMainScreen.field_243003_H,
                        p_237679_3_ + 10 + 40 + 75, p_237679_4_ + 12, k2);
            } else {
                int i = 225;
                int j = 2;

                if (p_237679_1_.field_230591_j_) {
                    RealmsMainScreen.this.func_237614_c_(p_237679_2_, p_237679_3_ + 225 - 14, p_237679_4_ + 2,
                            p_237679_5_, p_237679_6_);
                } else if (p_237679_1_.field_230586_e_ == RealmsServer.Status.CLOSED) {
                    RealmsMainScreen.this.func_237626_e_(p_237679_2_, p_237679_3_ + 225 - 14, p_237679_4_ + 2,
                            p_237679_5_, p_237679_6_);
                } else if (RealmsMainScreen.this.func_223885_h(p_237679_1_) && p_237679_1_.field_230593_l_ < 7) {
                    RealmsMainScreen.this.func_237606_b_(p_237679_2_, p_237679_3_ + 225 - 14, p_237679_4_ + 2,
                            p_237679_5_, p_237679_6_, p_237679_1_.field_230593_l_);
                } else if (p_237679_1_.field_230586_e_ == RealmsServer.Status.OPEN) {
                    RealmsMainScreen.this.func_237620_d_(p_237679_2_, p_237679_3_ + 225 - 14, p_237679_4_ + 2,
                            p_237679_5_, p_237679_6_);
                }

                if (!RealmsMainScreen.this.func_223885_h(p_237679_1_) && !RealmsMainScreen.field_224013_b) {
                    RealmsMainScreen.this.func_237630_f_(p_237679_2_, p_237679_3_ + 225, p_237679_4_ + 2, p_237679_5_,
                            p_237679_6_);
                } else {
                    RealmsMainScreen.this.func_237633_g_(p_237679_2_, p_237679_3_ + 225, p_237679_4_ + 2, p_237679_5_,
                            p_237679_6_);
                }
                ...
                if (!"0".equals(p_237679_1_.field_230599_r_.field_230607_a_)) {
                    ...
                    RealmsMainScreen.this.font.drawString(p_237679_2_, s,
                            (float) (p_237679_3_ + 207 - RealmsMainScreen.this.font.getStringWidth(s)),
                            (float) (p_237679_4_ + 3), 8421504);

                    if (p_237679_5_ >= p_237679_3_ + 207 - RealmsMainScreen.this.font.getStringWidth(s)
                            && p_237679_5_ <= p_237679_3_ + 207 && p_237679_6_ >= p_237679_4_ + 1
                            && p_237679_6_ <= p_237679_4_ + 10 && p_237679_6_ < RealmsMainScreen.this.height - 40
                            && p_237679_6_ > 32 && !RealmsMainScreen.this.func_223990_b()) {
                        RealmsMainScreen.this
                                .func_237603_a_(new StringTextComponent(p_237679_1_.field_230599_r_.field_230608_b_));
                    }
                }
                ...
                if (RealmsMainScreen.this.func_223885_h(p_237679_1_) && p_237679_1_.field_230591_j_) {
                    RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
                    RenderSystem.enableBlend();
                    RealmsMainScreen.this.minecraft.getTextureManager().bindTexture(RealmsMainScreen.field_237537_D_);
                    ...
                    if (p_237679_5_ >= j1 && p_237679_5_ < j1 + l && p_237679_6_ > k1
                            && p_237679_6_ <= k1 + 16 & p_237679_6_ < RealmsMainScreen.this.height - 40
                            && p_237679_6_ > 32 && !RealmsMainScreen.this.func_223990_b()) {
                        flag = true;
                    ...
                    AbstractGui.blit(p_237679_2_, j1 + l / 2, k1, (float) (200 - l / 2), (float) (46 + l1 * 20), l / 2,
                            8, 256, 256);
                    AbstractGui.blit(p_237679_2_, j1, k1 + 8, 0.0F, (float) (46 + l1 * 20 + 12), l / 2, 8, 256, 256);
                    AbstractGui.blit(p_237679_2_, j1 + l / 2, k1 + 8, (float) (200 - l / 2),
                            (float) (46 + l1 * 20 + 12), l / 2, 8, 256, 256);
                    RenderSystem.disableBlend();
                    int i2 = p_237679_4_ + 11 + 5;
                    int j2 = flag ? 16777120 : 16777215;
                    RealmsMainScreen.this.font.func_243248_b(p_237679_2_, itextcomponent, (float) (p_237679_3_ + 2),
                            (float) (i2 + 1), 15553363);
                    AbstractGui.drawCenteredString(p_237679_2_, RealmsMainScreen.this.font, itextcomponent1, j1 + l / 2,
                            i2 + 1, j2);
                } else {
                    if (p_237679_1_.field_230594_m_ == RealmsServer.ServerType.MINIGAME) {
                        ...
                        RealmsMainScreen.this.font.func_243248_b(p_237679_2_, RealmsMainScreen.field_243008_M,
                                (float) (p_237679_3_ + 2), (float) (p_237679_4_ + 12), 13413468);
                        RealmsMainScreen.this.font.drawString(p_237679_2_, p_237679_1_.func_230778_c_(),
                                (float) (p_237679_3_ + 2 + k), (float) (p_237679_4_ + 12), 7105644);
                    } else {
                        RealmsMainScreen.this.font.drawString(p_237679_2_, p_237679_1_.func_230768_a_(),
                                (float) (p_237679_3_ + 2), (float) (p_237679_4_ + 12), 7105644);
                    }

                    if (!RealmsMainScreen.this.func_223885_h(p_237679_1_)) {
                        RealmsMainScreen.this.font.drawString(p_237679_2_, p_237679_1_.field_230587_f_,
                                (float) (p_237679_3_ + 2), (float) (p_237679_4_ + 12 + 11), 5000268);
                    }
                }

                RealmsMainScreen.this.font.drawString(p_237679_2_, p_237679_1_.func_230775_b_(),
                        (float) (p_237679_3_ + 2), (float) (p_237679_4_ + 1), 16777215);
    ...
    class ServerList extends RealmsObjectSelectionList<RealmsMainScreen.ListEntry> {
        ...
        public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
            if (keyCode != 257 && keyCode != 32 && keyCode != 335) {
                ...
                return extendedlist$abstractlistentry == null ? super.keyPressed(keyCode, scanCode, modifiers)
                        : extendedlist$abstractlistentry.mouseClicked(0.0D, 0.0D, 0);
            }
        }

        public boolean mouseClicked(double mouseX, double mouseY, int button) {
            if (button == 0 && mouseX < (double) this.getScrollbarPosition() && mouseY >= (double) this.y0
                    && mouseY <= (double) this.y1) {
            ...
            if (p_231400_1_ != -1) {
                ...
                if (realmsserver == null) {
                    ...
                    if (RealmsMainScreen.this.field_224003_K >= 10 && RealmsMainScreen.this.field_224022_k.active) {
                        RealmsMainScreen.this.func_223911_a(
                                RealmsMainScreen.this.func_223967_a(RealmsMainScreen.this.field_224021_j),
                                RealmsMainScreen.this);
                    }
                }
            }
        ...
        public void setSelected(@Nullable RealmsMainScreen.ListEntry entry) {
            ...
            if (this.field_241824_o_ && i == 0) {
                RealmsNarratorHelper.func_239551_a_(I18n.format("mco.trial.message.line1"),
                        I18n.format("mco.trial.message.line2"));
            } else if (!this.field_241824_o_ || i > 0) {
                RealmsServer realmsserver = RealmsMainScreen.this.field_224028_q
                        .get(i - (this.field_241824_o_ ? 1 : 0));
                RealmsMainScreen.this.field_224021_j = realmsserver.field_230582_a_;
                RealmsMainScreen.this.func_223915_a(realmsserver);

                if (realmsserver.field_230586_e_ == RealmsServer.Status.UNINITIALIZED) {
                    RealmsNarratorHelper.func_239550_a_(
                            I18n.format("mco.selectServer.uninitialized") + I18n.format("mco.gui.button"));
                } else {
        ...
        public void func_231401_a_(int p_231401_1_, int p_231401_2_, double p_231401_3_, double p_231401_5_,
                int p_231401_7_) {
            if (this.field_241824_o_) {
                if (p_231401_2_ == 0) {
                ...
                if (realmsserver != null) {
                    if (realmsserver.field_230586_e_ == RealmsServer.Status.UNINITIALIZED) {
                        ...
                        MinecraftClient.getInstance()
                                .displayGuiScreen(new RealmsCreateRealmScreen(realmsserver, RealmsMainScreen.this));
                    } else {
                        RealmsMainScreen.this.field_224021_j = realmsserver.field_230582_a_;
                    }
    ...
    class TrialServerEntry extends RealmsMainScreen.ListEntry {
        ...
        private void func_237681_a_(MatrixStack p_237681_1_, int p_237681_2_, int p_237681_3_, int p_237681_4_,
                int p_237681_5_, int p_237681_6_) {
            int i = p_237681_4_ + 8;
            int j = 0;
            boolean flag = false;

            if (p_237681_3_ <= p_237681_5_
                    && p_237681_5_ <= (int) RealmsMainScreen.this.field_224020_i.getScrollAmount()
                    && p_237681_4_ <= p_237681_6_ && p_237681_6_ <= p_237681_4_ + 32) {
                flag = true;
            }
            ...
            for (ITextComponent itextcomponent : RealmsMainScreen.field_243002_G) {
                AbstractGui.drawCenteredString(p_237681_1_, RealmsMainScreen.this.font, itextcomponent,
                        RealmsMainScreen.this.width / 2, i + j, k);
                j += 10;
            }
        }
    }
