...
public class RealmsClient {
    ...
    private final MinecraftClient field_244732_f;
    ...
    public RealmsClient(String p_i242122_1_, String p_i242122_2_, Minecraft p_i242122_3_) {
        this.field_224947_d = p_i242122_1_;
        this.field_224948_e = p_i242122_2_;
        this.field_244732_f = p_i242122_3_;
        RealmsClientConfig.func_224896_a(p_i242122_3_.getProxy());
    }
    ...
    public void func_224900_a(long p_224900_1_, String p_224900_3_, String p_224900_4_) throws RealmsServiceException {
        ...
        String s = this
                .func_224926_c("worlds" + "/$WORLD_ID/initialize".replace("$WORLD_ID", String.valueOf(p_224900_1_)));
    ...
    public void func_224908_a(long p_224908_1_, String p_224908_3_) throws RealmsServiceException {
        String s = this.func_224926_c("invites" + "/$WORLD_ID/invite/$UUID"
                .replace("$WORLD_ID", String.valueOf(p_224908_1_)).replace("$UUID", p_224908_3_));
    ...
    public BackupList func_224923_d(long p_224923_1_) throws RealmsServiceException {
        String s = this
                .func_224926_c("worlds" + "/$WORLD_ID/backups".replace("$WORLD_ID", String.valueOf(p_224923_1_)));
        String s1 = this.func_224938_a(Request.func_224953_a(s));
    ...
    public void func_224925_a(long p_224925_1_, int p_224925_3_, RealmsWorldOptions p_224925_4_)
            throws RealmsServiceException {
        String s = this.func_224926_c("worlds" + "/$WORLD_ID/slot/$SLOT_ID"
                .replace("$WORLD_ID", String.valueOf(p_224925_1_)).replace("$SLOT_ID", String.valueOf(p_224925_3_)));
    ...
    public boolean func_224927_a(long p_224927_1_, int p_224927_3_) throws RealmsServiceException {
        String s = this.func_224926_c("worlds" + "/$WORLD_ID/slot/$SLOT_ID"
                .replace("$WORLD_ID", String.valueOf(p_224927_1_)).replace("$SLOT_ID", String.valueOf(p_224927_3_)));
    ...
    public void func_224928_c(long p_224928_1_, String p_224928_3_) throws RealmsServiceException {
        String s = this.func_224907_b("worlds" + "/$WORLD_ID/backups".replace("$WORLD_ID", String.valueOf(p_224928_1_)),
                "backupId=" + p_224928_3_);
        this.func_224938_a(Request.func_224966_b(s, "", 40000, 600000));
    }

    public WorldTemplatePaginatedList func_224930_a(int p_224930_1_, int p_224930_2_,
            RealmsServer.ServerType p_224930_3_) throws RealmsServiceException {
        String s = this.func_224907_b(
                "worlds" + "/templates/$WORLD_TYPE".replace("$WORLD_TYPE", p_224930_3_.toString()),
                String.format("page=%d&pageSize=%d", p_224930_1_, p_224930_2_));
        String s1 = this.func_224938_a(Request.func_224953_a(s));
    ...
    public Boolean func_224905_d(long p_224905_1_, String p_224905_3_) throws RealmsServiceException {
        String s = "/minigames/$MINIGAME_ID/$WORLD_ID".replace("$MINIGAME_ID", p_224905_3_).replace("$WORLD_ID",
                String.valueOf(p_224905_1_));
    ...
    public Ops func_224906_e(long p_224906_1_, String p_224906_3_) throws RealmsServiceException {
        String s = "/$WORLD_ID/$PROFILE_UUID".replace("$WORLD_ID", String.valueOf(p_224906_1_)).replace("$PROFILE_UUID",
                p_224906_3_);
    ...
    public Ops func_224929_f(long p_224929_1_, String p_224929_3_) throws RealmsServiceException {
        String s = "/$WORLD_ID/$PROFILE_UUID".replace("$WORLD_ID", String.valueOf(p_224929_1_)).replace("$PROFILE_UUID",
                p_224929_3_);
        String s1 = this.func_224926_c("ops" + s);
    ...
    public Boolean func_224943_a(long p_224943_1_, String p_224943_3_, Integer p_224943_4_, boolean p_224943_5_)
            throws RealmsServiceException {
        ...
        String s1 = this.func_224938_a(
                Request.func_224959_a(s, field_237691_f_.func_237694_a_(realmsworldresetdto), 30000, 80000));
        return Boolean.valueOf(s1);
    }

    public Boolean func_224924_g(long p_224924_1_, String p_224924_3_) throws RealmsServiceException {
        RealmsWorldResetDto realmsworldresetdto = new RealmsWorldResetDto((String) null, Long.valueOf(p_224924_3_), -1,
                false);
    ...
    public WorldDownload func_224917_b(long p_224917_1_, int p_224917_3_) throws RealmsServiceException {
        String s = this.func_224926_c("worlds" + "/$WORLD_ID/slot/$SLOT_ID/download"
                .replace("$WORLD_ID", String.valueOf(p_224917_1_)).replace("$SLOT_ID", String.valueOf(p_224917_3_)));
        String s1 = this.func_224938_a(Request.func_224953_a(s));
    ...
    public UploadInfo func_224934_h(long p_224934_1_, @Nullable String p_224934_3_) throws RealmsServiceException {
        String s = this.func_224926_c(
                "worlds" + "/$WORLD_ID/backups/upload".replace("$WORLD_ID", String.valueOf(p_224934_1_)));
        return UploadInfo
                .func_230796_a_(this.func_224938_a(Request.func_224965_c(s, UploadInfo.func_243090_b(p_224934_3_))));
    }
    ...
    private String func_224907_b(String p_224907_1_, @Nullable String p_224907_2_) {
        try {
            return (new URI(field_224944_a.field_224899_e, field_224944_a.field_224898_d, "/" + p_224907_1_,
                    p_224907_2_, (String) null)).toASCIIString();
        ...
        try {
            ...
            if (i != 503 && i != 277) {
                ...
                if (i >= 200 && i < 300) {
                    ...
                    field_224946_c.error("Realms http code: " + i + " -  error code: " + realmserror.func_224974_b()
                            + " -  message: " + realmserror.func_224973_a() + " - raw body: " + s);
