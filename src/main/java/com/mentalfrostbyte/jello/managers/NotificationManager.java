...
public class NotificationManager {
    ...
    public void onRender(EventRender event) {
        if (!MinecraftClient.getInstance().gameSettings.hideGUI) {
            for (int var4 = 0; var4 < this.notifications.size(); var4++) {
                ...
                int var7 = MinecraftClient.getInstance().getWindow().getWidth() - this.field39926
                        - (int) ((float) this.field39923 * var6 * var6);
                int var8 = this.mc.getWindow().getHeight()
                        - this.field39924
                        - this.field39925
    ...
    private void method31998() {
        for (int var3 = 0; var3 < this.notifications.size(); var3++) {
            ...
            int var6 = MinecraftClient.getInstance().getWindow().getWidth() - this.field39926
                    - (int) ((float) this.field39923 * var5 * var5);
            int var7 = this.mc.getWindow().getHeight()
                    - this.field39924
                    - this.field39925
