...
import static com.mentalfrostbyte.jello.util.EntityUtil.getCenteredHitbox;
...
public class RotationHelper {
    ...
    // public static float[] advancedRotation(LivingEntity var0, double var1, double
    // var3, double var5) {
    // double[] var9 = Class9047.method33642(var0);
    // double var10 = var9[0] - var1;
    // double var12 = var0.getPosY() - (double) mc.player.getEyeHeight() - 0.02F +
    // (double)var0.getEyeHeight() - var3;
    // double var14 = var9[2] - var5;
    // double var16 = (double) MathHelper.sqrt(var10 * var10 + var14 * var14);
    // float var18 = calculate(mc.player.rotationYaw, (float)(Math.atan2(var14,
    // var10) * 180.0 / Math.PI) - 90.0F, 360.0F);
    // float var19 = calculate(mc.player.rotationPitch, (float)(-(Math.atan2(var12,
    // var16) * 180.0 / Math.PI)), 360.0F);
    // return new float[]{var18, var19};
    // }

    public static float[] doBasicRotation(Entity target) {
        double var3 = mc.player.getPosX()
                + (mc.player.getPosX() - mc.player.lastTickPosX) * (double) mc.getRenderPartialTicks();
        double var5 = mc.player.getPosZ()
                + (mc.player.getPosZ() - mc.player.lastTickPosZ) * (double) mc.getRenderPartialTicks();
        double var7 = mc.player.getPosY()
                + (mc.player.getPosY() - mc.player.lastTickPosY) * (double) mc.getRenderPartialTicks();
    ...
    public static float[] calculateEntityRotations(Entity entity, double playerX, double playerZ, double playerY) {
        ...
        double interpolatedPosX = entity.getPosX()
                + (entity.getPosX() - entity.lastTickPosX) * mc.getRenderPartialTicks();
        double interpolatedPosZ = entity.getPosZ()
                + (entity.getPosZ() - entity.lastTickPosZ) * mc.getRenderPartialTicks();
        double interpolatedPosY = entity.getPosY()
                + (entity.getPosY() - entity.lastTickPosY) * mc.getRenderPartialTicks();
        ...
        float yaw = calculate(mc.player.rotationYaw, (float) (Math.atan2(deltaZ, deltaX) * 180.0 / Math.PI) - 90.0F,
                360.0F);
        float pitch = calculate(mc.player.rotationPitch,
                (float) (-(Math.atan2(deltaY, horizontalDistance) * 180.0 / Math.PI)), 360.0F);
    ...
    public static float[] method34139(LivingEntity var0, double var1, double var3, double var5) {
        ...
        double var11 = var0.getPosY() - (double) mc.player.getEyeHeight() - 0.02F + (double) var0.getEyeHeight() - var3
                - Math.random();
        double var13 = var0.getPosZ() - var5 + 0.25 - Math.random() * 0.5;
        double var15 = (double) MathHelper.sqrt(var9 * var9 + var13 * var13);
        float var17 = calculate(mc.player.rotationYaw, (float) (Math.atan2(var13, var9) * 180.0 / Math.PI) - 90.0F,
                360.0F);
        float var18 = calculate(mc.player.rotationPitch, (float) (-(Math.atan2(var11, var15) * 180.0 / Math.PI)),
                360.0F);
    ...
    public static float[] method34140(LivingEntity var0, double var1, double var3, double var5) {
        ...
        double var17 = var0.getPosY() - var3 - (double) mc.player.getEyeHeight() + (double) var0.getEyeHeight() - 0.02F
                - 0.6F - var11;
        double var19 = var0.getPosZ() - var5 + var13;
        double var21 = (double) MathHelper.sqrt(var15 * var15 + var19 * var19);
        float var23 = calculate(mc.player.rotationYaw, (float) (Math.atan2(var19, var15) * 180.0 / Math.PI) - 90.0F,
                360.0F);
        float var24 = calculate(mc.player.rotationPitch, (float) (-(Math.atan2(var17, var21) * 180.0 / Math.PI)),
                360.0F);
        return new float[] { var23, var24 };
    }

    public static Vec3d getLookVector(float var0, float var1) {
        ...
        return new Vec3d((double) (var7 * var8), (double) (-var9), (double) (var6 * var8));
    }
    ...
    public static float[] method34141(LivingEntity var0, double var1, double var3, double var5, float var7) {
        ...
        if (var10 == null) {
            if (field42015 <= new Date().getTime() - 500L) {
                ...
                double var19 = var0.getPosY() - var3 - (double) mc.player.getEyeHeight() + (double) var0.getEyeHeight()
                        - 0.02F - 0.6F - var13;
                double var21 = var0.getPosZ() - var5 + var15;
                double var23 = (double) MathHelper.sqrt(var17 * var17 + var21 * var21);
                field42013 = calculate(mc.player.rotationYaw,
                        (float) (Math.atan2(var21, var17) * 180.0 / Math.PI) - 90.0F, 360.0F);
                field42014 = calculate(mc.player.rotationPitch, (float) (-(Math.atan2(var19, var23) * 180.0 / Math.PI)),
                        360.0F);
    ...
    public static float method34142(float var0, float var1) {
        ...
        int var6 = var0 - var1 >= 0.0F && var0 - var1 <= 180.0F || var0 - var1 <= -180.0F && var0 - var1 >= -360.0F ? -1
                : 1;
    ...
    public static float[] method34145(Vec3d var0, Vec3d var1) {
        ...
        float var13 = calculate(mc.player.rotationPitch, (float) (-(Math.atan2(var8, var10) * 180.0 / Math.PI)),
                360.0F);
    ...
    public static Rotations getRotations(Entity targetIn, boolean throughWalls) {
        Vec3d var4 = getCenteredHitbox(targetIn);
        if (throughWalls && !raytraceVector(var4)) {
            for (int var5 = -1; var5 < 2; var5++) {
                ...
                float yaw = calculate(mc.player.rotationYaw,
                        (float) (Math.atan2(playerzPos, playerxPos) * 180.0 / Math.PI) - 90.0F, 360.0F);
                float pitch = calculate(mc.player.rotationPitch,
                        (float) (-(Math.atan2(playeryPos, var20) * 180.0 / Math.PI)), 360.0F);
                boolean position = raytraceVector(new Vec3d(xPos, yPos, zPos));
                if (position) {
                    return new Rotations(yaw, pitch);
                }

                for (int var25 = -1; var25 < 2; var25 += 2) {
                    xPos = targetIn.getPosX()
                            + (targetIn.getPosX() - targetIn.lastTickPosX) * (double) mc.getRenderPartialTicks();
                    zPos = targetIn.getPosZ()
                            + (targetIn.getPosZ() - targetIn.lastTickPosZ) * (double) mc.getRenderPartialTicks();
                    yPos = targetIn.getPosY() + 0.05
                            + (targetIn.getPosY() - targetIn.lastTickPosY) * (double) mc.getRenderPartialTicks() + var6;
                    ...
                    yaw = calculate(mc.player.rotationYaw,
                            (float) (Math.atan2(playerzPos, playerxPos) * 180.0 / Math.PI) - 90.0F, 360.0F);
                    pitch = calculate(mc.player.rotationPitch,
                            (float) (-(Math.atan2(playeryPos, var20) * 180.0 / Math.PI)), 360.0F);
                    position = raytraceVector(new Vec3d(xPos, yPos, zPos));
                    if (position) {
                        return new Rotations(yaw, pitch);
                    }
                }
