...
public class JelloMaps extends Screen {
   ...
   public JelloMaps() {
      ...
      int var3 = Math.max(300, Math.min(850, MinecraftClient.getInstance().getWindow().getWidth() - 40));
      int var4 = Math.max(200, Math.min(550, MinecraftClient.getInstance().getWindow().getHeight() - 80));
