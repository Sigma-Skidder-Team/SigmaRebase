...
public class ClassicParticleEngine extends AnimatedIconPanelWrap {
   ...
   public ClassicParticleEngine(CustomGuiScreen var1, String var2) {
      super(var1, var2, 0, 0, MinecraftClient.getInstance().getMainWindow().getWidth(),
   ...
   public void draw(float partialTicks) {
      this.method13225();
      int var4 = MinecraftClient.getInstance().getMainWindow().getScaledWidth();
      int var5 = MinecraftClient.getInstance().getMainWindow().getScaledHeight();
