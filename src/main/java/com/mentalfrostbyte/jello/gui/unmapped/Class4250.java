...
public class Class4250 extends UIBase {
   ...
   public Class4250(CustomGuiScreen var1, String var2, int var3, int var4, int var5, int var6, int var7, float var8,
   ...
   public void method13041(float var1, float var2, float var3, float var4) {
      ...
      this.field20608.method13144((float) this.field20610 + var7 * var1,
            (float) this.field20610 + var7 * (1.0F - var2));
      this.field20609.method13144((float) this.field20610 + var7 * var3,
            (float) this.field20610 + var7 * (1.0F - var4));
   }
