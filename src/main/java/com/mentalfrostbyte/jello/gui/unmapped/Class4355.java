...
public class Class4355 extends UIBase {
   ...
   public void draw(float var1) {
      RenderUtil.drawRoundedRect2(
            ...
            (float) this.widthA,
            (float) this.heightA,
            ColorUtils.applyAlpha(ColorUtils.shiftTowardsBlack(ClientColors.LIGHT_GREYISH_BLUE.getColor(), 0.03F),
      ...
      RenderUtil.drawRoundedRect2(
            (float) (this.xA + var5), (float) (this.yA + 27), 20.0F, 2.0F,
            ColorUtils.applyAlpha(ClientColors.DEEP_TEAL.getColor(), var6));
      RenderUtil.drawRoundedRect2(
            (float) (this.xA + var5), (float) (this.yA + 27 + 5), 20.0F, 2.0F,
            ColorUtils.applyAlpha(ClientColors.DEEP_TEAL.getColor(), var6));
      RenderUtil.drawRoundedRect2(
            (float) (this.xA + var5), (float) (this.yA + 27 + 10), 20.0F, 2.0F,
            ColorUtils.applyAlpha(ClientColors.DEEP_TEAL.getColor(), var6));
