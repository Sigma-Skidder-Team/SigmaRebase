...
public class Class4348 extends AnimatedIconPanelWrap {
   ...
   public void draw(float partialTicks) {
      ...
      if (this.method13272() + this.method13282() < MinecraftClient.getInstance().getMainWindow().getHeight() - 36
            ...
            try {
               ...
               if (var6 != null) {
                  ...
                  this.field21246 = BufferedImageUtil.getTexture(
                        "servericon",
                        ImageUtil.applyBlur(ImageUtil.method35042(method13579(var6, 2.5, 2.5), 0.0F, 1.1F, 0.0F), 25));
               }
         ...
         if (this.field21246 != null) {
            RenderUtil.drawImage(
                  ...
                  (float) this.widthA,
                  this.field21246,
                  ColorUtils.applyAlpha(ColorUtils.method17690(ClientColors.LIGHT_GREYISH_BLUE.getColor(),
   ...
   public void method13577() {
      ...
      RenderUtil.drawString(
            ...
            !this.field21244.serverName.equals("Minecraft Server")
                  ...
                  : this.field21244.serverIP.substring(0, 1).toUpperCase()
                        + this.field21244.serverIP.substring(1, this.field21244.serverIP.length()),
      ...
      if (this.field21243.method31735().getTime() != 9223372036854775806L) {
         if (var3 > 0L && this.field21243.method31735().getTime() != Long.MAX_VALUE) {
            RenderUtil.drawString(
                  ...
                  ColorUtils.method17690(ClientColors.DEEP_TEAL.getColor(), ClientColors.LIGHT_GREYISH_BLUE.getColor(),
                        0.2F));
            ...
            RenderUtil.drawString(
                  ...
                  (float) (this.yA + var13),
                  "Unbanned!",
                  ColorUtils.method17690(ClientColors.DARK_SLATE_GREY.getColor(),
            ...
            RenderUtil.drawString(
                  ...
                  (float) (this.yA + var13),
                  "Permanently banned!",
                  ColorUtils.method17690(ClientColors.PALE_YELLOW.getColor(),
                        ClientColors.LIGHT_GREYISH_BLUE.getColor(), 0.3F));
         }
      } else {
         RenderUtil.drawString(
               ...
               ColorUtils.method17690(ClientColors.DARK_OLIVE.getColor(), ClientColors.LIGHT_GREYISH_BLUE.getColor(),
                     0.3F));
      }
