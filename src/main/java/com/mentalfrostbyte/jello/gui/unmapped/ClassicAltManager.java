...
public class ClassicAltManager extends CustomGuiScreen {
   ...
   public ClassicAltManager(CustomGuiScreen var1, String var2, int var3, int var4) {
      ...
      this.addToList(
            this.field21141 = new Class4300(this, "back", 0, 48, 120, 40, "Back", ClientColors.DEEP_TEAL.getColor()));
      int var7 = 200;
      int var8 = 146;
      int var9 = this.getWidthA() - 625;
      this.addToList(this.field21142 = new Class4300(this, "login", var9, 0, var7, 40, "Login",
            ClientColors.DEEP_TEAL.getColor()));
      this.addToList(this.field21145 = new Class4300(this, "direct", var9 + var7 + 16, 0, var7, 40, "Direct Login",
            ClientColors.DEEP_TEAL.getColor()));
      ...
      this.addToList(this.field21146 = new Class4300(this, "edit", var9 + var8 * 2 + 32, 48, var8, 40, "Edit",
            ClientColors.DEEP_TEAL.getColor()));
      this.addToList(this.field21148 = new Class4300(this, "alpha", var9 + var8 * 3 + 48, 48, var8, 40, "Alphalts",
            ClientColors.DEEP_TEAL.getColor()));
      ...
      this.field21141.doThis((var0, var1x) -> MinecraftClient.getInstance().displayGuiScreen(new MainMenuScreen()));
