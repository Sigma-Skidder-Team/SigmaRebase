...
import com.mentalfrostbyte.jello.gui.impl.ClassicAddAlt;
...
public class ClassicAltManager extends CustomGuiScreen {
      ...
      public ClassicAltManager(CustomGuiScreen var1, String var2, int var3, int var4) {
            ...
            this.addToList(this.field21140 = new Class4300(this, "reload", 0, 0, 120, 40, "Reload",
                        ClientColors.DEEP_TEAL.getColor()));
            this.addToList(
                        this.field21141 = new Class4300(this, "back", 0, 48, 120, 40, "Back",
                                    ClientColors.DEEP_TEAL.getColor()));
            int var7 = 200;
            int var8 = 146;
            int var9 = this.getWidthA() - 625;
            this.addToList(this.field21142 = new Class4300(this, "login", var9, 0, var7, 40, "Login",
                        ClientColors.DEEP_TEAL.getColor()));
            this.addToList(
                        this.field21145 = new Class4300(this, "direct", var9 + var7 + 16, 0, var7, 40, "Direct Login",
                                    ClientColors.DEEP_TEAL.getColor()));
            this.addToList(this.field21147 = new Class4300(this, "add", var9 + var7 * 2 + 32, 0, var7, 40, "Add",
                        ClientColors.DEEP_TEAL.getColor()));
            this.addToList(this.field21143 = new Class4300(this, "random", var9, 48, var8, 40, "Random",
                        ClientColors.DEEP_TEAL.getColor()));
            this.addToList(this.field21144 = new Class4300(this, "remove", var9 + var8 + 16, 48, var8, 40, "Remove",
                        ClientColors.DEEP_TEAL.getColor()));
            this.addToList(this.field21146 = new Class4300(this, "edit", var9 + var8 * 2 + 32, 48, var8, 40, "Edit",
                        ClientColors.DEEP_TEAL.getColor()));
            this.addToList(
                        this.field21148 = new Class4300(this, "alpha", var9 + var8 * 3 + 48, 48, var8, 40, "Alphalts",
                                    ClientColors.DEEP_TEAL.getColor()));
            SigmaClassicAltManager var10 = (SigmaClassicAltManager) this.getParent();
            this.field21143
                        .doThis(
                                    (var1x, var2x) -> {
                                          Account var5 = Client.getInstance().accountManager
                                                      .getAccounts()
                                                      .get(new Random().nextInt(Client.getInstance().accountManager
                                                                  .getAccounts().size()));
                                          var10.method13399(var5);
                                    });
            this.field21141
                        .doThis((var0, var1x) -> MinecraftClient.getInstance().displayGuiScreen(new MainMenuScreen()));
            ...
            this.field21145.doThis(
                        (var0, var1x) -> Client.getInstance().guiManager.handleScreen(new ClassicDirectLogin()));
      }
