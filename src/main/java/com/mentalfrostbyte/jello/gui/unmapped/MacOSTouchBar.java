   ...
   public void displayKeybindsInfo() {
      if (this.isValidMacOS()) {
         if (this.touchBar != null) {
            this.touchBar
                  .hide(GLFWNativeCocoa.glfwGetCocoaWindow(MinecraftClient.getInstance().getWindow().getHandle()));
         }
         ...
         this.touchBar
               .show(GLFWNativeCocoa.glfwGetCocoaWindow(MinecraftClient.getInstance().getWindow().getHandle()));
