...
public class LoginScreen extends UIBase {
      ...
      public LoginScreen(CustomGuiScreen var1, String var2, int var3, int var4, int var5, int var6) {
            ...
            this.addToList(
                        new UITextDisplay(
                                    ...
                                    new ColorHelper(ClientColors.DEEP_TEAL.getColor(),
                                                ...
                                                ClientColors.DEEP_TEAL.getColor(), -7631989),
                                    "Login",
                                    ResourceRegistry.JelloMediumFont40));
            this.addToList(
                        this.loginButton = new UIButton(
                                    this, "LoginButton", 468, 238, ResourceRegistry.JelloLightFont25.getWidth("Login"),
                                    70,
                                    ColorHelper.field27961, "Login", ResourceRegistry.JelloLightFont25));
            this.addToList(
                        this.registerButton = new UIButton(
                                    this, "RegisterButton", 88, 250,
                                    ResourceRegistry.JelloLightFont14.getWidth("Register"), 14,
                                    ColorHelper.field27961, "Register", ResourceRegistry.JelloLightFont14));
            this.addToList(
            ...
            int var10 = 300;
            int var11 = 106;
            ColorHelper var12 = new ColorHelper(-892679478, -892679478, -892679478, ClientColors.MID_GREY.getColor(),
                        Class2218.field14488, Class2218.field14492);
            this.addToList(
                        this.inputUsername = new UIInput(this, "Username", 228, var11, var10, var9, var12, "",
                                    "Username"));
            this.addToList(
                        this.inputPassword = new UIInput(this, "Password", 228, var11 + 53, var10, var9, var12, "",
                                    "Password"));
            ...
            this.addToList(
                        this.field21355 = new UIInput(this, "CaptchaBox", 228, var11 + 135, 84, var9, var12, "",
                                    "Captcha"));
            ...
            this.forgotButton
                        .doThis((var0, var1x) -> Util.getOperatingSystem().open("https://sigma-web-alpha.vercel.app/"));
      }
            ...
            if (var5 != null) {
                  ...
                  if (var5.method36702()) {
                        RenderUtil.drawRoundedRect2(
                                    (float) (this.xA + 330), (float) (this.yA + 255), 114.0F, 40.0F,
                                    ColorUtils.applyAlpha(ClientColors.DEEP_TEAL.getColor(), 0.04F));
                  }
