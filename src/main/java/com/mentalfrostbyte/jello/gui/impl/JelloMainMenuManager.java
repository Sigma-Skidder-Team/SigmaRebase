...
public class JelloMainMenuManager extends Screen {
    ...
    public JelloMainMenuManager() {
        ...
        int var3 = MinecraftClient.getInstance().getMainWindow().getWidth()
                * MinecraftClient.getInstance().getMainWindow().getHeight() / 14000;
        Random var4 = new Random();

        for (int var5 = 0; var5 < var3; var5++) {
            int var6 = var4.nextInt(MinecraftClient.getInstance().getMainWindow().getWidth());
            int var7 = var4.nextInt(MinecraftClient.getInstance().getMainWindow().getHeight());
    ...
    public void draw(float partialTicks) {
        ...
        if (MinecraftClient.getInstance().loadingGui != null) {
            ...
            float parallaxFactor = 0.5F - (float) this.field20967
                    / (float) MinecraftClient.getInstance().getMainWindow().getWidth() * -1.0F;
    ...
    public void logout() {
        if (this.alertPanel == null) {
            this.runThisOnDimensionUpdate(() -> {
                ...
                this.showAlert(this.alertPanel = new AlertPanel(this, "music", true, "Dependencies.",
