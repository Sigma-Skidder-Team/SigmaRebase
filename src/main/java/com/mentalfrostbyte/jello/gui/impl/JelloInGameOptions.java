...
public class JelloInGameOptions extends Screen {
   ...
   public void updatePanelDimensions(int newHeight, int newWidth) {
      if (field21112.getDirection() == Direction.BACKWARDS && field21112.calcPercent() == 0.0F && field21115 != null) {
         MinecraftClient.getInstance().displayGuiScreen(field21115);
      }
   ...
   public void draw(float var1) {
      ...
      int var6 = ColorUtils.method17690(-1072689136, ColorUtils.applyAlpha(ClientColors.DEEP_TEAL.getColor(), 0.1F),
            var5);
      int var7 = ColorUtils.method17690(-804253680, ColorUtils.applyAlpha(ClientColors.DEEP_TEAL.getColor(), 0.1F),
            var5);
