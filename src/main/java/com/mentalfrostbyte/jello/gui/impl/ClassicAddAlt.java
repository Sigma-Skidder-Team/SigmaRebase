...
public class ClassicAddAlt extends Screen {
   ...
   public ClassicAddAlt() {
      ...
      this.addToList(
            this.field21116 = new SigmaClassicTextBox(this, "username", var5, var4, var3, 45,
                  SigmaClassicTextBox.field20741, "", "Username / E-Mail", ResourceRegistry.DefaultClientFont));
      var4 += 80;
      this.addToList(this.field21117 = new SigmaClassicTextBox(this, "password", var5, var4, var3, 45,
            SigmaClassicTextBox.field20741, "", "Password", ResourceRegistry.DefaultClientFont));
      var4 += 190;
      this.addToList(this.field21118 = new Class4300(this, "login", var5, var4, var3, 40, "Login",
            ClientColors.MID_GREY.getColor()));
      var4 += 50;
      this.addToList(this.field21119 = new Class4300(this, "back", var5, var4, var3, 40, "Back",
            ClientColors.MID_GREY.getColor()));
      var4 += 50;
      this.addToList(this.field21120 = new Class4300(this, "import", var5, var4, var3, 40, "Import user:pass",
            ClientColors.MID_GREY.getColor()));
      ...
      this.field21120.doThis((var1, var2) -> {
         ...
         try {
            var5x = GLFW.glfwGetClipboardString(MinecraftClient.getInstance().getMainWindow().getHandle());
