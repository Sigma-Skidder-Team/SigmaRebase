...
public class JelloOptionsMainMenu extends CustomGuiScreen {
      public JelloOptionsMainMenu(CustomGuiScreen var1, String var2, int var3, int var4, int var5, int var6) {
            ...
            var10.doThis((var0, var1x) -> JelloInGameOptions
                        .method13438(new KeyboardScreen(new LiteralText("Keybind Manager"))));
            var11.doThis((var0, var1x) -> JelloInGameOptions.method13438(new ClickGui(new LiteralText("Click GUI"))));
            var12.doThis((var0, var1x) -> JelloInGameOptions
                        .method13438(new CreditToCreatorsScreen(new LiteralText("GuiCredits"))));
            UICheckBox var13;
      ...
      public void draw(float var1) {
            ...
            String var5 = "Click GUI is currently bound to: "
                        + RenderUtil.getKeyName(
                                    Client.getInstance().moduleManager.getMacOSTouchBar().getKeybindFor(ClickGui.class))
                        + " Key";
            RenderUtil.drawString(
                        ResourceRegistry.JelloLightFont20,
                        (float) (this.getXA()
            ...
            RenderUtil.drawString(
                        ResourceRegistry.JelloLightFont20,
                        (float) (this.getXA()
                                    + (this.getWidthA() - ResourceRegistry.JelloLightFont20.getWidth(var7)) / 2 - 114),
            ...
            RenderUtil.drawString(
                        ResourceRegistry.JelloLightFont20,
                        (float) (this.getXA()
                                    + (this.getWidthA() - ResourceRegistry.JelloLightFont20.getWidth(var8)) / 2 + 52),
                        (float) (this.getYA() + this.getHeightA() - 221),
                        var8,
                        ColorUtils.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.getColor(), 0.5F * var1));
            super.draw(var1);
      ...
      private void method13463(int var1, int var2, float var3) {
            ...
            RenderUtil.drawString(
                        ...
                        ColorUtils.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.getColor(), 0.86F * var3));
      }
}
