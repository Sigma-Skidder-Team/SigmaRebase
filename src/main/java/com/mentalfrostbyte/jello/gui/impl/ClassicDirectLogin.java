      ...
      public ClassicDirectLogin() {
            ...
            this.addToList(
                        this.field20985 = new SigmaClassicTextBox(this, "username", var5, var4, var3, 45,
                                    SigmaClassicTextBox.field20741, "", "Username / E-Mail",
            ...
            this.field20988
                        .doThis((var0, var1) -> Client.getInstance().guiManager
                                    .handleScreen(new SigmaClassicAltManager()));
            this.field20989.doThis((var1, var2) -> {
                  String var5x = "";

                  var5x = GLFW.glfwGetClipboardString(MinecraftClient.getInstance().getWindow().getHandle()) == null
                              ? ""
                              : GLFW.glfwGetClipboardString(MinecraftClient.getInstance().getWindow().getHandle());
